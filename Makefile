...
ootb:
	...
	tar -zcvf gorg64_2.0.0-3_amd64.tar.gz ./gorg64/
	-rm -f -r ./gorg64
...
install:
	dpkg -i gorg64_2.0.0-3_amd64.deb
...
deb:
	...
	cd debian && ar q ../gorg64_2.0.0-3_amd64.deb debian-binary control.tar.xz data.tar.xz
	-rm -f ./debian/control.tar.xz ./debian/data.tar.xz data.tar md5sums
	-lintian --tag-display-limit 0 gorg64_2.0.0-3_amd64.deb && alien --scripts -r gorg64_2.0.0-3_amd64.deb
